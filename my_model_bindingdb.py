...
ds=MyMolProtDataset("../data/BindingDB/train.txt")
model=MyModel()
...
plt.savefig("emb_vision_bindingDB.jpg")
...
plt.savefig("emb1_vision_bindingDB.jpg")
...
plt.savefig("emb2_vision_bindingDB.jpg")
