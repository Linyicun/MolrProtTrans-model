...
ds=MyMolProtDataset("../data/kinase_test.txt")
model=MyModel()
...
print()
ds_test=MyMolProtDataset("../data/BindingDB/train.txt")
...
for batch in test_loader:
    ...
    plt.xlabel('fpr')
    plt.ylabel('tpr')
    plt.savefig("roc_BindingDB.jpg")
    plt.show()

    f_roc_data=open('my_model_bindingDB_ROC_data.txt',"w")
