...
if __name__ == "__main__":
    ...
    """Output files."""
    file_AUCs = 'output/result/transformer_davis'+ '.txt'
    file_model = 'output/model/' + 'transformer_davis'
    AUCs = ('Epoch\tTime(sec)\tLoss_train\tR_score')
    ...
    for epoch in range(1, iteration+1):
        ...
        rs = tester.test(dataset_dev)

        end = timeit.default_timer()
        time = end - start

        Rs = [epoch, time, loss_train, rs]
        tester.save_Rs(Rs, file_AUCs)
